...
namespace Launcher
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (job.Redelivered)
            {
                Log.Error("Engine.Run(): Job Version: " + job.Version + "  Deployed Version: " + QuantConnect.Globals.Version + " Redelivered: " + job.Redelivered);
            ...
            try
            {
                ...
                algorithmManager = new AlgorithmManager(QuantConnect.Globals.LiveMode, job);
