...
namespace SignalRadar.Algorithm
{
    ...
    {
        public static void Load(BrokerageName brokerageName, DateTime startDatetime, DateTime endDateTime, SecurityType securityType, SecurityManager securities, Resolution resolution)
        {
            foreach (var securty in securities.Values)
            {
